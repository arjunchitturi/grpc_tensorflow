...
pub struct ExampleList {
    ...
    pub examples: ::std::vec::Vec<super::Example>,
}
...
pub struct ExampleListWithContext {
    ...
    pub context: ::std::option::Option<super::Example>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Input {
...
pub struct SignatureDefMap {
    ...
    pub signature_def: ::std::collections::HashMap<std::string::String, super::SignatureDef>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct PredictRequest {
    ...
    #[prost(map = "string, message", tag = "2")]
    pub inputs: ::std::collections::HashMap<std::string::String, super::TensorProto>,
    /// Output filter.
...
pub struct PredictResponse {
    ...
    /// Output tensors.
    #[prost(map = "string, message", tag = "1")]
    pub outputs: ::std::collections::HashMap<std::string::String, super::TensorProto>,
}
